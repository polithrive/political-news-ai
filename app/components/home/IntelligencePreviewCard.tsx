...
export default function IntelligencePreviewCard({
  ...
  return (
    <article className="w-full max-w-xl overflow-hidden rounded-3xl border border-slate-800 bg-slate-900 shadow-2xl shadow-black/30">
      ...
      <div className="p-6">
        ...
        <button
          ...
          disabled={!article}
          className="mt-6 flex w-full items-center justify-center rounded-xl bg-white px-5 py-4 font-semibold text-slate-950 transition hover:bg-slate-200 disabled:cursor-not-allowed disabled:opacity-50"
        >
