      ...
      <div className="mx-auto flex min-h-20 max-w-[1500px] items-center gap-5 px-5 sm:px-8">
        ...
        >
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-red-600 text-white shadow-sm">
            ...
            >
              <path
                d="M3 12h4l2.2-5 3.2 10 2.4-6H21"
                stroke="currentColor"
                strokeWidth="2.2"
                strokeLinecap="round"
          ...
          <div className="mx-auto max-w-[1500px]">
            <div className="mb-3 md:hidden">
              <input
                ...
                className="w-full rounded-xl border border-slate-800 bg-slate-950 px-4 py-3 text-sm text-slate-100 placeholder:text-slate-500 outline-none"
              />
            </div>
