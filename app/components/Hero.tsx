export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-slate-950">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center px-8 pb-28 pt-36 text-center">
        ...
        <p className="mt-8 max-w-3xl text-xl leading-8 text-gray-400">
          PoliticalPulse uses AI to summarize breaking political news, compare
          viewpoints across the political spectrum, identify potential bias,
          and provide the context you need to make informed decisions.
        </p>
        ...
        <div className="mt-20 grid w-full max-w-5xl grid-cols-1 gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 backdrop-blur">
            ...
            <p className="mt-2 text-gray-400">
              Get concise, neutral summaries of today&apos;s biggest political
              stories.
            </p>
          </div>
